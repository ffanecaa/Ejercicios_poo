...
public class ListaAlimentos extends Food {
    ...
    public static void agregarNuevoAlimento() {
        ...
        if (alimentoYaExiste) {
           ...
           ArchivoGestor.escribirEnArchivoFood  (ruta, contenido);
    ...
    public static ListaAlimentos asociarGramosyFood() {
        String ruta = "C:/Users/marti/OneDrive/Documentos/GitHub/ejerci_poo/ejercicios_poo/src/main/java/com/campusdual/alimentos.txt";
        ArrayList<String> FoodArray = ArchivoGestor.recuperarContenidoComoArrayList(ruta);
        ...
        if (seleccion >= 1 && seleccion <= FoodArray.size()) {
            ...
            ListaAlimentos alimentosSeleccionados = new ListaAlimentos(nombreAlimento,calorias,carbos,proteinas,grasas,gramos);
    ...
    public String dameDatosListaAlimentos(Food alimentoSeleccionados, Integer gramos) {
